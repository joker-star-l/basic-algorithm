...
[题解](https://leetcode.cn/problems/reorder-list/solutions/2843011/yi-mu-liao-ran-de-tu-shi-bu-zou-by-shawx-k3o8/)

做法: 快慢指针找中间节点，断开中间节点与后半部分链表的连接 -> 反转后半部分链表 -> 交叉合并两个链表
...
### 400. 第 N 位数字
[题目](https://leetcode.cn/problems/nth-digit)
[题解](https://leetcode.cn/problems/nth-digit/solutions/2362054/400-di-n-wei-shu-zi-qing-xi-tu-jie-by-jy-sz5y/)

做法: 确定所求数位的所在数字的位数 -> 确定所求数位所在的数字 num -> 确定所求数位在 num 的哪一数位
...
[题解](https://leetcode.cn/problems/design-circular-queue/solutions/1713181/she-ji-xun-huan-dui-lie-by-leetcode-solu-1w0a/)

做法: 数组留一个空位，区分空状态和满状态
...
[题解（方法二）](https://leetcode.cn/problems/valid-parenthesis-string/solutions/992347/you-xiao-de-gua-hao-zi-fu-chuan-by-leetc-osi3)

做法: 两个栈，一个记录左括号下标，另一个记录星号下标


### 773. 滑动谜题
[题目](https://leetcode.cn/problems/sliding-puzzle)
[题解](https://leetcode.cn/problems/sliding-puzzle/solutions/845241/gong-shui-san-xie-fa-hui-a-suan-fa-zui-d-3go8/)

做法: BFS，看作是 0 的移动，把二维数组转换成一维字符串简化流程
...
[题解](https://leetcode.cn/problems/super-egg-drop/solutions/2949779/jiao-ni-yi-bu-bu-si-kao-dpcong-ji-yi-hua-xkbx/)

做法: （先做 1884. 鸡蛋掉落-两枚鸡蛋）动态规划，dfs(i, j) = dfs(i − 1, j) + dfs(i − 1, j − 1) + 1，首个满足 dfs(i, k) >= n 的 i 便是答案
...
[题解（方法二）](https://leetcode.cn/problems/egg-drop-with-2-eggs-and-n-floors/solutions/2945577/liang-chong-fang-fa-dong-tai-gui-hua-shu-hd4i/)

做法: 数学，x + (x − 1) + (x − 2) + ⋯ + 2 + 1 >= n
